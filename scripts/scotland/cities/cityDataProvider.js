const cityArray = [
    {
        ...
        population:"593,245",
        description:"Glasgow, Gaelic Glaschu, city, west-central Scotland. It is situated along both banks of the River Clyde 20 miles (32 km) from that river’s mouth on the western, or Atlantic, coast. Glasgow is Scotland’s largest city, and it forms an independent council area that lies entirely within the historic county of Lanarkshire.",
    ...
    },
    {
        ...
        population:"482,640",
        description:"Edinburgh, Gaelic Dun Eideann, capital city of Scotland, located in southeastern Scotland with its centre near the southern shore of the Firth of Forth, an arm of the North Sea that thrusts westward into the Scottish Lowlands.Edinburgh is a city of sombre theatricality, with much of this quality deriving from its setting among crags and hills and from its tall buildings and spires of dark stone.",
